...
const ThankYou = () => {
  return (
    <>
      <div className="min-h-[calc(100vh-18rem)] flex flex-col items-center justify-center px-4">
            ...
            <div className="flex justify-between items-center gap-20 w-full pl-[1rem] lg:pl-0">
              <Link smooth={true} to="/" className="cursor-pointer">
                <img
                  ...
                  width={150}
                  height={150}
                  className="h-[2.5rem] sm:h-[3rem] md:h-[3.75rem] scale-110 sm:scale-125"
                  alt="logo"
                />
              </Link>
            </div>
        ...
        <div className="wrapper flex flex-col items-center justify-center h-full text-center">
